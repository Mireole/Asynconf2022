...
class Exo3Test(unittest.TestCase):
    ...
    def test_commandes(self, mock_print):
        utils.return_values = ["ajouter", "Réparer la ventilation", "La ventilation a actuellement un disfonctionnement", "Administrateur",
                               "ajouter-compte", "Crewmate", "n", "n",
                               "ajouter", "Réparer le système de chauffage", "Ca caille ici !", "Administrateur,Crewmate",
                               "connecter", "Crewmate",
                               "liste",
